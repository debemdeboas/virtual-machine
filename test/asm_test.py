...
class AssemblyTest(unittest.TestCase):
    ...
    def test_fibonacci(self):
        ...
        for address, result in [(50, 0), (51, 1), (58, 21), (59, 34)]:
            with self.subTest(address=address, result=result):
                self.assertEqual(self.vm.memory.access(address).execute(), result)
    ...
    def test_p2(self):
        ...
        amount = self.vm.memory._inner_memory[1].p
        start_address = self.vm.memory._inner_memory[2].p
    ...
    def test_p3(self):
        ...
        number = self.vm.memory._inner_memory[3].p
        ...
        self.assertEqual(self.vm.memory.access(50).execute(), factorial)
    ...
    def test_p4(self):
        ...
        self.assertEqual(literal_array, [self.vm.memory.access(i).execute() for i in range(300, 350)])
